...
# Contentpulse Lead Magnet — Codex CLI wrapper

This is the **Codex CLI wrapper** for `contentpulse-lead-magnet`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.
