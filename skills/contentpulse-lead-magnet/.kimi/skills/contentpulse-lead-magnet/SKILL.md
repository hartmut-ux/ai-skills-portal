...
# Contentpulse Lead Magnet — Kimi Code CLI wrapper

This is the **Kimi Code CLI wrapper** for `contentpulse-lead-magnet`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.
