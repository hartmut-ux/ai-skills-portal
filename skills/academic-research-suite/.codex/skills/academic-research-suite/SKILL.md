...
# Academic Research Suite — Codex CLI wrapper

This is the **Codex CLI wrapper** for `academic-research-suite`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.
