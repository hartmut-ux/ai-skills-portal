...
# Digitalscheck Navigator — Kimi Code CLI wrapper

This is the **Kimi Code CLI wrapper** for `digitalscheck-navigator`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.

## When to use

Use when the user asks for:
- `/digitalscheck-navigator`
- "run digitalscheck-navigator"
