---
name: example-skill
description: Example multi-platform skill for Kimi Code CLI. Demonstrates the shared-core + thin-wrapper pattern.
---

# Example Skill — Kimi wrapper

This is the **Kimi Code CLI wrapper** for `example-skill`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.
