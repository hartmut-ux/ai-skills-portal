...
# Fullstack App Builder — Codex CLI wrapper

This is the **Codex CLI wrapper** for `fullstack-app-builder`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.
