...
# Fullstack App Builder — Claude Code wrapper

This is the **Claude Code wrapper** for `fullstack-app-builder`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.
