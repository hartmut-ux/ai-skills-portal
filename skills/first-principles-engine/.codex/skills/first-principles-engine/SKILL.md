...
# First Principles Engine — Codex CLI wrapper

This is the **Codex CLI wrapper** for `first-principles-engine`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.
