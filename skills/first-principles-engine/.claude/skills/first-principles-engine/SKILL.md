...
# First Principles Engine — Claude Code wrapper

This is the **Claude Code wrapper** for `first-principles-engine`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.

## When to use

Use when the user asks for:
- `first-principles-engine`
- "run first-principles-engine"
