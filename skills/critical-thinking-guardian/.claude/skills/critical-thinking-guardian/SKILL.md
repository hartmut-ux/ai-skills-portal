...
# Critical Thinking Guardian — Claude Code wrapper

This is the **Claude Code wrapper** for `critical-thinking-guardian`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.
