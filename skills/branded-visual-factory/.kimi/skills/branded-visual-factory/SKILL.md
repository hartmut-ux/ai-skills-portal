...
# Branded Visual Factory — Kimi Code CLI wrapper

This is the **Kimi Code CLI wrapper** for `branded-visual-factory`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.

## When to use

Use when the user asks for:
- `/branded-visual-factory`
- "run branded-visual-factory"
