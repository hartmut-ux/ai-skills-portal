...
# Grok Research Engine — Claude Code wrapper

This is the **Claude Code wrapper** for `grok-research-engine`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.
