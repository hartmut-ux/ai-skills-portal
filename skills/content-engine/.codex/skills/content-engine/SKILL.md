...
# Content Engine — Codex CLI wrapper

This is the **Codex CLI wrapper** for `content-engine`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.
